...
public:
    ...
    Studentas(const std::string& v_, const std::string& p_, double egz_rez_, double rez_, const std::deque<double>& nd_rez_);    // konstruktorius su parametrais
    ...
    const std::deque<double>& getNd_rez() const { return nd_rez; }
