...
Studentas::Studentas(const std::string& v_, const std::string& p_, double mediana, double egz_rez_, double rez_, const std::vector<double>& nd_rez_){
    v = v_;
    p = p_;
    egz_rez = egz_rez_;
...
double Studentas::ApskaiciuotiMediana() const {
    ...
    std::vector<double> scores = nd_rez;
